...
.main_div
{
    width:100%;
    height:100vh;
    background-image:linear-gradient(to right, #ccffcc,#ccff99,#99ff66,#00ff00,#33cc33,#009933);
...
.contactus:before{
    ...
    bottom: 0;
    right:0;
    background:linear-gradient(20deg,#ccff99 55%, #33cc33 0%);
    z-index: -1;
}
.formbutton button{
...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center"><h2>ARPAN BANK</h2></a>
      ...
      <span class="navbar-toggler-icon" style="background:white;"></span>
       ...
       <div class="collapse navbar-collapse text-center" id="collapsenavbar">
          <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                  <a href="index.php" class="nav-link text-white "><span style="margin-left:90px;">HOME</span></a></li>
              <li class="nav-item">
                  <a href="viewcustomers.php" class="nav-link text-white ">CUSTOMER LIST</a></li>
              <li class="nav-item">
                  <a href="transfermoney.php" class="nav-link text-white"></a></li>
              <li class="nav-item">
                  <a href="#contact" class="nav-link text-white">GET IN TOUCH</a></li>    
               </ul>
        </div>
     </div>
     <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="main_text">ARPAN BANK</h1>
            <p class="big-text">Always at Your Service</p>
          </div>
          <div class="col-sm-6">
  ...
  <section class="contactus" id="contact" >
        <div class="container headings text-center">
            <h1 class="center" style="font-weight: bold;text-align: center;">GET IN TOUCH</h1>
            <p>Pl. feel free to ask us anything</p>
        </div>
        <div class="container">
            <div class="row">
